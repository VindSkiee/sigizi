        ...
        <div className="max-w-3xl mx-auto px-4 -mt-5 relative z-10 space-y-4">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-4">
            {process.env.NEXT_PUBLIC_DEMO_MODE === "true" && (
              <div className="text-center bg-amber-50 border border-amber-200 rounded-lg px-4 py-3">
                <p className="text-sm font-semibold text-amber-800">
                  Report Key:{" "}
                  <span className="font-bold">{batch.reportKey}</span>
                </p>
                <p className="text-xs text-amber-600 mt-0.5">
                  * Report key ditampilkan karena Anda berada di lingkungan demo
                </p>
              </div>
            )}
